...
public class PosDataTransService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        while (!isSendPosStop) {
            ...
            // objeto de solicitação de construção
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "erro de suspensão de thread" + e.getMessage(), e);
            }
        }
    }
    ...
    private class PosDataTransCallback implements Callback {
        ...
        public void onFailure(Call call, IOException e) {
            e.printStackTrace();
            Log.e(TAG, "Erro ao carregar informações de localização：" + e.getMessage(), e);
        }
